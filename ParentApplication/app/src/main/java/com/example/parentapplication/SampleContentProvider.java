    ...
    public String getType(@NonNull Uri uri) {
        switch (MATCHER.match(uri)) {
            case CODE_DIR: {
                ...
                return "vnd.android.cursor.dir/" + AUTHORITY + "." + Launcher.TABLE_NAME;
            }
            case CODE_ITEM: {
                //return "vnd.android.cursor.item/" + AUTHORITY + "." + Cheese.TABLE_NAME;
                return "vnd.android.cursor.item/" + AUTHORITY + "." + Launcher.TABLE_NAME;
            }
            default:
                throw new IllegalArgumentException("Unknown URI: " + uri);
        }
    ...
    public Uri insert(@NonNull Uri uri, @Nullable ContentValues values) {
        switch (MATCHER.match(uri)) {
            case CODE_DIR:
                ...
                final long id = SampleDatabase.getInstance(context).launcherDao().insert(Launcher.fromContentValues(values));
    ...
    public int delete(@NonNull Uri uri, @Nullable String selection,
        ...
        switch (MATCHER.match(uri)) {
            ...
            case CODE_ITEM:
                ...
                final int count = SampleDatabase.getInstance(context).launcherDao().deleteById(ContentUris.parseId(uri));
                context.getContentResolver().notifyChange(uri, null);
                return count;
            default:
                throw new IllegalArgumentException("Unknown URI: " + uri);
    ...
    public int update(@NonNull Uri uri, @Nullable ContentValues values, @Nullable String selection,
        ...
        switch (MATCHER.match(uri)) {
            ...
            case CODE_ITEM:
                ...
                final Launcher launcher = Launcher.fromContentValues(values);
                ...
                final int count = SampleDatabase.getInstance(context).launcherDao().update(launcher);
